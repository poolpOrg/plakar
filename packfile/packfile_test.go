...
func TestTypes(t *testing.T) {
	...
	require.Equal(t, []Type{TYPE_SNAPSHOT, TYPE_CHUNK, TYPE_OBJECT, TYPE_VFS, TYPE_VFS_ENTRY, TYPE_INDEX, TYPE_INDEX_ENTRY, TYPE_SIGNATURE, TYPE_ERROR}, list)
}
